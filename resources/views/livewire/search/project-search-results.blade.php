<div>
    @include('partials.search._results-toolbar', [
        'heading' => 'Search this project',
        'subheading' => 'Search files, experiments, samples, processes, and datasets in '.$project->name.'.',
        'query' => $query,
    ])
    ...
    @if(blank($query))
        <div class="alert alert-light border">
            Enter a search term to search this project.
        </div>
