<div class="float-right">
    <a class="action-link me-3" href="{{route('projects.datasets.edit', [$project, $dataset])}}">Edit</a>
    <a class="action-link me-3" href="{{route('projects.datasets.index', [$project])}}">Done</a>
