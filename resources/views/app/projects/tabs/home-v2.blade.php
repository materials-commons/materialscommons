...
@push('scripts')
    <script>
        (function () {
            ...
            wireCollapse('proj-ai-semantic', 'proj-ai-semantic-toggle', '{{$projKey}}_ai_semantic', false);
            wireCollapse('proj-ai-data-extraction', 'proj-ai-data-extraction-toggle', '{{$projKey}}_ai_data_extraction', false);
            wireCollapse('proj-ai-transform', 'proj-ai-transform-toggle', '{{$projKey}}_ai_transform', false);
