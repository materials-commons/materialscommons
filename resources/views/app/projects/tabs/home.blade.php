        ...
        <div class="card-deck">
            <div class="card bg-light" style="border-color: #b3c2d9">
                <div class="card-body">
                    ...
                    <p>
                        ...
                        through the Materials Commons command line program or API, and using the Globus transfer
                        service.
                    </p>
                    <div class="card-text">
                        <ul class="list-unstyled ml-3">
                            ...
                            <li>
                                <a href="{{route('projects.globus.downloads.index', [$project])}}">Globus download
                                    files</a>
                            </li>
            ...
            <div class="card bg-light" style="border-color: #b3c2d9">
                <div class="card-body">
                    ...
                    <div class="card-text">
                        <ul class="list-unstyled ml-3">
                            <li><a href="{{route('projects.datasets.index', [$project])}}">View project datasets</a>
                            </li>
