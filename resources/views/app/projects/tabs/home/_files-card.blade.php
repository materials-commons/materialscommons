            ...
            <div class="transfer-options">
                <div class="transfer-option mb-3">
                    ...
                    <a href="{{route('projects.upload-files', [$project])}}" class="text-primary">
                        Start web upload <i class="fas fa-arrow-right ml-1"></i>
                    </a>
                </div>
                ...
                <div class="transfer-option mb-3">
                    ...
                    <div class="d-flex flex-wrap">
                        <a href="{{route('projects.globus.uploads.index', [$project])}}" class="text-primary mr-3">
                            Upload via Globus <i class="fas fa-arrow-right ml-1"></i>
                        </a>
                        <a href="{{route('projects.globus.downloads.index', [$project])}}" class="text-primary">
                            Download via Globus <i class="fas fa-arrow-right ml-1"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="transfer-option">
                    ...
                    <div class="d-flex flex-wrap">
                        <a href="https://materials-commons.github.io/materials-commons-cli/html/manual/up_down_globus.html"
                           target="_blank" class="text-primary mr-3">
                            CLI Guide <i class="fas fa-external-link-alt ml-1"></i>
                        </a>
                        <a href="https://materials-commons.github.io/materials-commons-api/html/manual/file_upload_download.html"
                           target="_blank" class="text-primary">
                            API Guide <i class="fas fa-external-link-alt ml-1"></i>
                        </a>
                    </div>
                </div>
            </div>
