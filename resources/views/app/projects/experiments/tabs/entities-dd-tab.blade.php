...
<div class="d-flex align-items-center mb-3">
    <button class="btn btn-link btn-sm p-0 text-decoration-none text-muted d-flex align-items-center gap-2"
            type="button"
            id="eea-analytics-toggle"
            data-bs-toggle="collapse"
            data-bs-target="#eea-analytics"
            aria-expanded="false"
            aria-controls="eea-analytics">
        <i class="fas fa-chevron-right fa-fw"
           id="eea-analytics-chevron"
...
<div class="collapse mb-1" id="eea-analytics">
...
@push('scripts')
    <script>
        (function () {
            (function () {
                const STORAGE_KEY = 'mc_eea_analytics_open';
                const panel = document.getElementById('eea-analytics');
                const chevron = document.getElementById('eea-analytics-chevron');
                const toggle = document.getElementById('eea-analytics-toggle');
