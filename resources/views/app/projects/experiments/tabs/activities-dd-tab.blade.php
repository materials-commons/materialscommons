...
<x-collapsible-section title="KPI"
                       id="activities-dd-kpi"
                       storage-key="proj_ex_activites_dd_kpi">
...
<x-collapsible-section title="Analytics"
                       id="proj_activities_eea-analytics"
                       :resize-plotly="true"
                       storage-key="proj_exp_activities_ea_analytics">
    @if($totalAttrs > 0)
