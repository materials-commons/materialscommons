<ul class="nav nav-tabs mb-2">
    <li class="nav-item">
        <a wire:navigate class="nav-link no-underline {{setActiveNavByName('projects.experiments.show')}}"
    ...
    <li class="nav-item">
        <a wire:navigate class="nav-link no-underline {{setActiveNavByName('projects.experiments.entities')}}"
    ...
    <li class="nav-item">
        <a wire:navigate
           class="nav-link no-underline {{setActiveNavByName('projects.experiments.computations.entities')}}"
    ...
    <li class="nav-item">
        <a wire:navigate
           class="nav-link no-underline {{setActiveNavByName('projects.experiments.data-dictionary.entities')}}"
    ...
    <li class="nav-item">
        <a wire:navigate
           class="nav-link no-underline {{setActiveNavByName('projects.experiments.data-dictionary.activities')}}"
    ...
    <li class="nav-item">
        <a wire:navigate class="nav-link no-underline {{setActiveNavByName('projects.experiments.workflow')}}"
    ...
    <li class="nav-item">
        <a wire:navigate class="nav-link no-underline {{setActiveNavByName('projects.experiments.etl_runs')}}"
