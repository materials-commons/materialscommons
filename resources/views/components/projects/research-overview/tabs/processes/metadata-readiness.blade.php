    ...
    <div class="card-body p-3 background-white">
        <div class="d-flex align-items-start justify-content-between gap-2 mb-3">
            <div>
                <h6 class="card-title text-muted mb-1">
                    <i class="fas fa-clipboard-check me-1"></i>Process Metadata
                </h6>
                <p class="text-muted mb-0" style="font-size:.85rem;">
                    Metadata readiness for process attributes, descriptions, types, and tags.
                </p>
            </div>
        ...
        @if((int) ($metrics['totalProcesses'] ?? 0) === 0)
            <div class="text-center text-muted py-4">
                ...
                <div class="fw-semibold">No process metadata yet</div>
