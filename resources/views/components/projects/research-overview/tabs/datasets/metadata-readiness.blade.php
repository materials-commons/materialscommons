    ...
    <div class="card-body p-3 background-white">
        <div class="d-flex align-items-start justify-content-between gap-2 mb-3">
            <div>
                ...
                <p class="text-muted mb-0" style="font-size:.85rem;">
                    Metadata readiness for descriptions, authors, licenses, DOIs, and tags.
                </p>
            </div>
        ...
        @if((int) ($metrics['totalDatasets'] ?? 0) === 0)
            <div class="text-center text-muted py-4">
                ...
                <div class="fw-semibold">No dataset metadata yet</div>
                <div style="font-size:.85rem;">Create datasets to track metadata readiness.</div>
            </div>
        @else
