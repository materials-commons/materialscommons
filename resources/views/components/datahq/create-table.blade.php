<div x-data="datahqCreateTableModal">
    <x-modal :id="$modalId" :title="'Create New Table'">
        ...
        <x-slot:footer>
            <a class="btn btn-success" @click.prevent="handleCreateViewForTable(event)">Create View</a>
        </x-slot:footer>

        @push('scripts')
            <script>
                mcutil.onAlpineInit("datahqCreateTableModal", () => {
                    return {
