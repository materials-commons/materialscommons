...
class ShowPublishedDatasetDataDictionaryEntityAttributesWebController extends Controller
{
    ...
    public function __invoke(Request $request, $datasetId)
    {
        ...
        $viewModel = (new ShowPublishedDatasetDataDictionaryViewModel())
            ...
            ->withEntityAttributes($this->getUniqueEntityAttributesForDataset($this->dataset->id));
