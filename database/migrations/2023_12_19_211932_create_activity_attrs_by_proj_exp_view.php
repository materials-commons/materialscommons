...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        create view activity_attrs_by_proj_exp as
             select act.name as activity_name, act.project_id, e2a.experiment_id, a.name as attribute_name, json_extract(av.val, '$.value') as attribute_value, av.unit as attribute_unit
             from activities act
